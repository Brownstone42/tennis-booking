                ...
                <div v-else class="settings-grid animate-fade">
                    ...
                    <section class="settings-card">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select
                                    v-model.number="localConfig.operatingHours.open"
                                    class="form-input"
                                >
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    v-model.number="localConfig.operatingHours.close"
                                    class="form-input"
                                >
                                    <option v-for="h in hourOptions" :key="h" :value="h">
                                        {{ formatTime(h) }}
                    ...
                    <section class="settings-card">
                        ...
                        <div class="court-editor-list">
                            <div
                                v-for="(court, index) in localConfig.courts"
                                :key="index"
                                class="court-edit-item"
                            >
                                <input
                                    v-model="court.name"
                                    placeholder="ชื่อคอร์ท"
                                    class="form-input-sm"
                                />
                                <input
                                    v-model="court.type"
                                    placeholder="ลักษณะคอร์ท"
                                    class="form-input-sm"
                                />
                                <button class="btn-danger-sm" @click="removeCourt(index)">
                                    ลบ
                                </button>
                            </div>
                        </div>
                    ...
                    <section class="settings-card full-width">
                        ...
                        <div class="pricing-content">
                                ...
                                <h4>
                                    {{
                                        activePricingTab === 'default'
                                            ? 'ราคากลาง (ใช้กับทุกคอร์ทที่ไม่ได้กำหนดราคาแยก)'
                                            : `ราคาเฉพาะสำหรับ ${activeCourtName}`
                                    }}
                                </h4>
                                <button class="btn-sm outline" @click="addPricingRow">
                                    + เพิ่มช่วงราคา
                                </button>
                            </div>
                            ...
                            <div class="pricing-grid">
                                <div
                                    v-for="(price, index) in currentPricingList"
                                    :key="index"
                                    class="price-edit-row"
                                >
                                    ...
                                    <div class="price-input-wrapper">
                                        ...
                                        <input
                                            ...
                                            class="form-input-inline price-field"
                                        />
                                    </div>
                                    <button class="btn-danger-sm" @click="removePricingRow(index)">
                                        ลบ
                                    </button>
                                </div>
...
.price-edit-row {
    display: grid;
    grid-template-columns: auto 120px auto 120px auto 1fr auto;
    align-items: center;
    gap: 12px;
    background: white;
    padding: 12px 16px;
